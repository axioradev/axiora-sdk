...
class FilingsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            path_template("/v1/filings/{doc_id}", doc_id=doc_id),
    ...
    def retrieve_sections(
        ...
        *,
        ...
        if not doc_id:
            raise ValueError(f"Expected a non-empty value for `doc_id` but received {doc_id!r}")
        return self._get(
            path_template("/v1/filings/{doc_id}/sections", doc_id=doc_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
    ...
    def retrieve_translations(
        ...
        *,
        ...
        if not doc_id:
            raise ValueError(f"Expected a non-empty value for `doc_id` but received {doc_id!r}")
        return self._get(
            path_template("/v1/filings/{doc_id}/translations", doc_id=doc_id),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
