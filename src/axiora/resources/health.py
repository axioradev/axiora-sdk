...
from ..types.health_check_deep_response import HealthCheckDeepResponse
    ...
    def check_deep(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=HealthCheckDeepResponse,
        )
...
class HealthResourceWithRawResponse:
    def __init__(self, health: HealthResource) -> None:
        ...
        self.check_deep = to_raw_response_wrapper(
            health.check_deep,
        )
...
class AsyncHealthResourceWithRawResponse:
    def __init__(self, health: AsyncHealthResource) -> None:
        ...
        self.check_deep = async_to_raw_response_wrapper(
            health.check_deep,
        )
...
class HealthResourceWithStreamingResponse:
    def __init__(self, health: HealthResource) -> None:
        ...
        self.check_deep = to_streamed_response_wrapper(
            health.check_deep,
        )
...
class AsyncHealthResourceWithStreamingResponse:
    def __init__(self, health: AsyncHealthResource) -> None:
        ...
        self.check_deep = async_to_streamed_response_wrapper(
            health.check_deep,
        )
