...
class TestWellKnown:
    ...
    @parametrize
    def test_method_retrieve_authorization_server_metadata(self, client: Axiora) -> None:
        well_known = client.well_known.retrieve_authorization_server_metadata()
        assert_matches_type(object, well_known, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_authorization_server_metadata(self, client: Axiora) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_authorization_server_metadata(self, client: Axiora) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_protected_resource_metadata(self, client: Axiora) -> None:
        well_known = client.well_known.retrieve_protected_resource_metadata()
        assert_matches_type(object, well_known, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_protected_resource_metadata(self, client: Axiora) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_protected_resource_metadata(self, client: Axiora) -> None:
...
class TestAsyncWellKnown:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_authorization_server_metadata(self, async_client: AsyncAxiora) -> None:
        well_known = await async_client.well_known.retrieve_authorization_server_metadata()
        assert_matches_type(object, well_known, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_authorization_server_metadata(self, async_client: AsyncAxiora) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_authorization_server_metadata(self, async_client: AsyncAxiora) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_protected_resource_metadata(self, async_client: AsyncAxiora) -> None:
        well_known = await async_client.well_known.retrieve_protected_resource_metadata()
        assert_matches_type(object, well_known, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_protected_resource_metadata(self, async_client: AsyncAxiora) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_protected_resource_metadata(self, async_client: AsyncAxiora) -> None:
