...
```sh
$ pip install git+ssh://git@github.com/axioradev/axiora-sdk.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/axioradev/axiora-sdk/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
